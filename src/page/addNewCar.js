    ...
    <div>
      ...
      >
        <div className="d-flex">
          ...
          <p className="fw-bold">List data pegawai</p>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
          ...
          <p className="fw-bold">Add Pegawai baru</p>
        </div>
        <h4 className="fw-bold mt-2">Add Pegawai baru</h4>
        <div
              ...
              <tr>
                ...
                <td>
                  <select
                    ...
                    onChange={handleChange}
                  >
                    <option value="small">Staff</option>
                    <option value="medium">Kontrak</option>
